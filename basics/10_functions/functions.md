...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Paola','Campos'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print_fullname(firstname = 'Paola', lastname = 'Campos')
...
def print_name(firstname):
    return firstname
print_name('Paola') # Paola

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Paola', lastname='Campos')
```
...
def generate_full_name (first_name = 'Paola', last_name = 'Campos'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
